...
(1, 'Playeras', 'pllayeras descripcion'),
(2, 'LLaveros', '');
...
INSERT INTO supply (`code`, internal_code, `name`, is_expired, expiration_date, date_of_admission, cost, quantity, availability, description, id_measure) VALUES
(1, 'afds', 'Pintura Amarilla', 0, '2020-05-14', '2020-03-03', 15.6, 13.2, 1, 'jdgjdgh', 1),
(2, 'dsfa56', 'Pintura Roja', 1, '2019-12-10', '2020-03-05', 19.5, 45, 1, 'fsdadasf', 1),
(3, 'dhg46', 'Maisena', 1, '2020-06-12', '2020-03-19', 15.2, 12, 1, 'fsda', 4),
(4, 'sdaf', 'nose', 1, '2020-08-13', '2020-03-04', 14.2, 16.4, 0, 'gfds', 3);
